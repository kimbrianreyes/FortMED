...
<head>
    ...
    <title>Santa Rosa Clinic Specialist Schedule</title>
    <style>
    .modal {
        display: none;
        position: fixed;
...
<body>
    ...
    <section id="santarosa-schedule" class="santarosa-schedule section">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <h2>Santa Rosa Clinic Specialist Schedule</h2>
                <p>Our General Practitioner / Primary Care Physicians are always available during clinic operating
                    hours.</p>
                <div style="text-align: center; margin-top: 20px;">
                    <img id="myImg" src="assets/img/patients/santarosasched.png"
                        alt="Santa Rosa Clinic Specialist Schedule" class="responsive-img">
                </div>
            </div>
        </div>
    </section>
